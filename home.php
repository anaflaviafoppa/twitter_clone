		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
					...
					if($('#texto_tweet').val().length > 0){
						...
						$.ajax({
							...
							success: function(data){
								//apagar o escrito do tweet assim que twitar
								$('#texto_tweet').val('');
								atualizaTweet();
				...
				function atualizaTweet(){
					...
					//carrega os tweets na timeline - com o ajax, a página não precisa fazer refresh
					$.ajax({
						url: 'get_tweet.php',
						success: function(data){
							$('#tweets').html(data);
	    		...
	    		<div class="panel panel-default">
	    			<div class="panel-body">
	    				<form id="form_tweet" class="input-group">
	    					<input type="text" id="texto_tweet" class="form-control" placeholder="O que está acontecendo agora?" maxlength="140" name="texto_tweet"/>
